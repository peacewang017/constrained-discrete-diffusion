...
sbatch \
  ...
  --job-name=eval_amazon_polarity_gen_ppl_${MODEL} \
  eval_amazon_polarity_gen_ppl.sh
comment
...
generated_seqs_path="${CKPT}/samples-amazon_polarity-gen-ppl-eval-_T-${SAMPLING_STEPS}_seed-${SEED}.json"
